...
namespace aprilslam
{
    ...
    private:
        ...
        ///@brief Save pose data to .txt.
        void SavePoseData (bool SaveFile,const geometry_msgs::Pose &pose);
        void Frontend_debug(bool SaveFile, const std::vector<Apriltag> tags_c_good);
