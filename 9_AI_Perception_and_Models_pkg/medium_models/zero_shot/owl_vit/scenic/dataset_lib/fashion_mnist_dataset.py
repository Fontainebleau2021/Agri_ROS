...
"""Data generators for the fashion-MNIST dataset."""
...
@datasets.add_dataset('fashion_mnist')
def get_dataset(*,
                batch_size,
                eval_batch_size,
                num_shards,
  ...
  logging.info('Loading train split of the Fashion-MNIST dataset.')
  ...
  logging.info('Loading test split of the Fashion-MNIST dataset.')
  ...
  meta_data = {
      ...
      'input_shape':
          input_shape,
      'num_train_examples':
          dataset_utils.get_num_examples('fashion_mnist', 'train'),
      'num_eval_examples':
          dataset_utils.get_num_examples('fashion_mnist', 'test'),
      'input_dtype':
