...
def get_config(runlocal=''):
  ...
  config.dataset_configs.max_num_captions = 1
  config.dataset_configs.caption_string = 'caption/string'
  config.dataset_configs.caption_string_train = 'caption/string'
  config.dataset_configs.include_verb = False
  ...
  config.verb_phrase_loss_weight = 0.
