...
r"""Config for Youcook2 Dense Captioning.
...
def get_config():
  ...
  config.experiment_name = 'vid2seq_youcook2_streaming_input_output'
  ...
  config.dataset_configs.test_annotation_path = common.YOUCOOK2_ANN_VID2SEQ_FORMAT_PATH
  tokenizer_path = 't5'
  ...
  def get_preproc_spec_train(num_frames, num_dense_outputs, no_timestamp_in_context):
    preproc_spec_train = (
        ...
        f"context_mask_ratio={context_mask_ratio}, no_timestamp_in_context={no_timestamp_in_context}, dynamic_location=True, only_use_augmented_context=True)"
  ...
  num_epochs = 120
  iters_per_epoch = common.YOUCOOK2_TRAIN_SIZE // config.batch_size
