...
def get_config():
  ...
  config.experiment_name = 'densevoc_vln'
  ...
  config.dataset_configs.max_frames_train = 3
  config.dataset_configs.max_frames_test = 3
  config.dataset_configs.train_data_path = common.VLN_UVO_TRAIN_PATH
  config.dataset_configs.test_data_path = common.VLN_UVO_VAL_PATH
  config.dataset_configs.test_annotation_path = common.VLN_UVO_VAL_ANN_PATH
  ...
  config.model.max_num_tracks = 16
  config.model.hard_tracking_frames = 3
  ...
  config.weights = '/path/to/densevoc_multidataset_pretraining'
  ...
  # config.chota_caption_metric = 'cider'
