...
"""Config for deformable boundary attention model."""

import ml_collections


def get_deformable_boundary_attention_model_config():
  """Returns config for deformable boundary attention model."""

  model_config = ml_collections.ConfigDict()
  model_config.name = 'deformable_boundary_attention'
  ...
  model_config.opts.delta = .02
  model_config.opts.eta = .01
  ...
  hidden_dim = 64
  model_config.model_opts.hidden_dim = hidden_dim

  # Initialization options
  model_config.model_opts.init_opts = ml_collections.ConfigDict()
  model_config.model_opts.init_opts.normalize_input = True
  model_config.model_opts.init_opts.crop_output = True
  model_config.model_opts.init_opts.hidden_dim = hidden_dim
  ...
  model_config.model_opts.refine_opts.deformation_type = 'simple'
  model_config.model_opts.refine_opts.offset_fn = 'dense'
  model_config.model_opts.refine_opts.max_offset = 30
  model_config.model_opts.refine_opts.num_samples = 20
  model_config.model_opts.refine_opts.offset_token_dim = 8
  model_config.model_opts.refine_opts.hidden_dim = hidden_dim
  ...
  model_config.model_opts.refine_opts.num_attention_heads = 3
