...
def get_config():
  ...
  config.experiment_name = f'ssv2_mtv_{MODEL_VARIANT}'
  ...
  config.dataset_configs.num_frames = 48
  ...
  config.dataset_configs.augmentation_params.rand_augment_num_layers = 1
