...
r"""Configs for training a MTV(L/2) with CVA on Kinetics-700.
...
KINETICS_700_TRAIN_SIZE = 0
KINETICS_700_VAL_SIZE = 0
KINETICS_700_TEST_SIZE = 0
...
def get_config():
  ...
  config.experiment_name = f'k700_mtv_{MODEL_VARIANT}'
  ...
  config.dataset_configs.examples_per_subset = {
      'train': KINETICS_700_TRAIN_SIZE,
      'validation': KINETICS_700_VAL_SIZE,
      'test': KINETICS_700_TEST_SIZE
  }
  config.dataset_configs.num_classes = 700
  ...
  # Learning rate.
  steps_per_epoch = KINETICS_700_TRAIN_SIZE // config.batch_size
