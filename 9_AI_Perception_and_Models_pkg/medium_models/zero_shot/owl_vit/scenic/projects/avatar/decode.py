...
"""Fast decoding routines at inference from a trained model.

From third_party/py/flax/examples/wmt/decode.py
"""
...
# Constants
# We assume the default End-of-Sentence token id is 1
EOS_ID = 1
