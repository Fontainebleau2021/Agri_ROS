...
def get_config():
  ...
  config.experiment_name = 'centernet2_O365_ViTDetH_LSJ_75e'

  # Dataset.
  config.dataset_name = 'coco_centernet_detection'
  config.dataset_configs = ml_collections.ConfigDict()
  config.dataset_configs.train_data_path = 'path/to/objects_365_train.tfrecord'
  config.dataset_configs.test_data_path = 'path/to/objects_365_val.tfrecord'
  config.dataset_configs.test_annotation_path = 'path/to/annotations/zhiyuan_objv2_val.json'
  config.dataset_configs.num_train_examples = 1_742_289
  config.dataset_configs.num_eval_examples = 80_000
  config.dataset_configs.prefetch_to_device = 2
  config.dataset_configs.shuffle_buffer_size = 10_000
  config.dataset_configs.max_boxes = 100
  config.dataset_configs.train_augmentation_type = 'resize_crop'
  config.dataset_configs.test_augmentation_type = 'resize_crop'
  ...
  config.model.roi_num_classes = 365
