...
def get_config():
  ...
  config.experiment_name = 'centernet_ViTDetB_S4_LSJ_4x'
  ...
  config.model.strides = (4,)
  config.model.fpn_range = ((0, 1000000),)
  config.model.vitdet_num_top_blocks = 0
  config.model.vitdet_scale_factors = (4.,)
  ...
  config.model.backbone_args.img_size = 1024
