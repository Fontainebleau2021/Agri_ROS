...
def get_config(runlocal=''):
  ...
  config.experiment_name = 'avmae-vggsound-pretrain'
  # Dataset.
  ...
  config.masked_feature_loss.modality_weight = ml_collections.ConfigDict(
      {'spectrogram': 0.5, 'rgb': 0.5})
