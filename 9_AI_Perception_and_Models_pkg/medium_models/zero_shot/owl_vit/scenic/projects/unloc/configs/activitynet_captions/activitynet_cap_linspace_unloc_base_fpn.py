...
r"""Configs for finetuning UnLoc-B model on ActivityNet Captions.
...
def get_config():
  ...
  config.dataset_configs.name = 'activitynet_cap'
  ...
  config.dataset_configs.eval_max_num_captions = 27
  ...
  config.lr_configs.decay_events = [25 * steps_per_epoch]
