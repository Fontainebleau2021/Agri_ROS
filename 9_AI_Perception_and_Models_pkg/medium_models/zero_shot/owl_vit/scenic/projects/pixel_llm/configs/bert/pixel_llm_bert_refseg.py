...
r"""Default configs for fine-tuning referring expression segmentation on RefCOCO wiht BERT.
...
def get_config():
  ...
  config.dataset_configs.train.sources = [
      # get_coco_ref_train_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcoco_unc', refexp_field=refexp_field, mask_on=True),
      # get_coco_ref_train_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocog_umd', refexp_field=refexp_field, mask_on=True),
      # get_coco_ref_train_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocoplus_unc', refexp_field=refexp_field, mask_on=True),
      get_coco_ref_train_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='merge_coco_img_safe', refexp_field=refexp_field, mask_on=True),
  ]
  ...
  config.dataset_configs.eval.sources = [
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcoco_unc', split='validation', refexp_field=refexp_field, mask_on=True),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcoco_unc', split='testA', refexp_field=refexp_field, mask_on=True),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcoco_unc', split='testB', refexp_field=refexp_field, mask_on=True),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocog_umd', split='validation', refexp_field=refexp_field, mask_on=True),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocog_umd', split='test', refexp_field=refexp_field, mask_on=True),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocoplus_unc', split='validation', refexp_field=refexp_field, mask_on=True),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocoplus_unc', split='testA', refexp_field=refexp_field, mask_on=True),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocoplus_unc', split='testB', refexp_field=refexp_field, mask_on=True),
  ]
  ...
  config.model.mask_adapter_args = ml_collections.ConfigDict()
  config.model.mask_adapter_args.gating = True
  config.model.mask_loss_weight = 1.0
  ...
  config.multi_weights_args.weights = (
      '/path/to/sam_h/',
      '/path/to/pixel_llm_bert_ref',
  )
  config.multi_weights_args.load_replace = (
      (('image_encoder', 'sam_backbone'),),
      (),
  )
  config.force_init = True  # load SAM
  ...
  config.optimizer.backbone_multiplier = 10.0
  config.optimizer.backbone_layer_prefix = 'mask_adapter'
