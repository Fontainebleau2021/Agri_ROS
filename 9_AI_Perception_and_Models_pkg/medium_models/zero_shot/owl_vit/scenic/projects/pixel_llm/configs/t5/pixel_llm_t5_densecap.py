...
r"""Default configs for fine-tuning dense object captioning on Visual Genome wiht T5.
...
def get_config():
  ...
  config.experiment_name = 'pixel_llm_t5_densecap'
  ...
  config.weights='/path/to/pixel_llm_t5_trace',
