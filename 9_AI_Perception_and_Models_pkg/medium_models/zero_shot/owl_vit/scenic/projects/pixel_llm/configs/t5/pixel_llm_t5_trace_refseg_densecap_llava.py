...
def get_config():
  ...
  config.experiment_name = 'pixel_llm_t5_trace_refseg_densecap_llava'
  ...
  config.dataset_configs.eval.sources = [
      ...
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, 16, crop_size, dataset_name='refcoco_unc', split='validation', refexp_field=refexp_field, use_text_as_context=use_text_as_context, mask_on=True),
