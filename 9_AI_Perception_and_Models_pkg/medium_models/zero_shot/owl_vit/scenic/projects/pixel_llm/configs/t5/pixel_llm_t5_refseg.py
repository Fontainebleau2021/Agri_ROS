...
r"""Default configs for fine-tuning referring expression localization on RefCOCO wiht T5.
...
def get_config():
  ...
  config.experiment_name = 'pixel_llm_t5_refseg'
  ...
  config.dataset_configs.train.sources = [
      get_coco_ref_train_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='merge_coco_img_safe', refexp_field=refexp_field, mask_on=True, use_text_as_context=use_text_as_context),
  ]
  ...
  config.dataset_configs.eval.sources = [
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcoco_unc', split='validation', refexp_field=refexp_field, mask_on=True, use_text_as_context=use_text_as_context),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcoco_unc', split='testA', refexp_field=refexp_field, mask_on=True, use_text_as_context=use_text_as_context),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcoco_unc', split='testB', refexp_field=refexp_field, mask_on=True, use_text_as_context=use_text_as_context),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocog_umd', split='validation', refexp_field=refexp_field, mask_on=True, use_text_as_context=use_text_as_context),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocog_umd', split='test', refexp_field=refexp_field, mask_on=True, use_text_as_context=use_text_as_context),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocoplus_unc', split='validation', refexp_field=refexp_field, mask_on=True, use_text_as_context=use_text_as_context),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocoplus_unc', split='testA', refexp_field=refexp_field, mask_on=True, use_text_as_context=use_text_as_context),
      get_coco_ref_eval_source(tokenizer_path, max_text_tokens, max_context_tokens, max_boxes, crop_size, dataset_name='refcocoplus_unc', split='testB', refexp_field=refexp_field, mask_on=True, use_text_as_context=use_text_as_context),
  ]
