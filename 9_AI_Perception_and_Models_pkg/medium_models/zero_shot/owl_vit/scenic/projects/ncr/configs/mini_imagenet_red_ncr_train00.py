...
r"""NCR config on mini-ImageNet-Red with 0% noise ratio.
...
MINI_IMAGENET_RED_TRAIN_SIZE = 50000
NUM_CLASSES = 100
...
def get_config(runlocal=''):
  ...
  config.dataset_configs.dataset = 'controlled_noisy_web_labels/mini_imagenet_red'
  config.dataset_configs.num_classes = NUM_CLASSES
  config.dataset_configs.train_split = 'train_00'   # Choose between train_00, train_20, train_40, train_80
  ...
  # Learning rate.
  steps_per_epoch = MINI_IMAGENET_RED_TRAIN_SIZE // config.batch_size
  ...
  config.ncr.number_neighbours = 10
