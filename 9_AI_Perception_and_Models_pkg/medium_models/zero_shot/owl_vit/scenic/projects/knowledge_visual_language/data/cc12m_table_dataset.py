...
"""Dataset and Loader for cc12m dataset for retrieval training.
...
def get_default_dataset_config():
  ...
  dataset_configs.pp_train = (
      f'decode|resize(resize_size={IMAGE_SIZE})|value_range(-1,1)|t5_tokenize(max_num_tokens={KNOWLEDGE_MAX_LENGTH},'
      ' inkey="texts", outkey="knowledge_tokens",'
...
@datasets.add_dataset('cc12m_table')
def get_dataset(
    *,
    batch_size,
    eval_batch_size,
